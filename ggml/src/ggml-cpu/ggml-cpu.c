                ...
                case GGML_OP_BLOCKED_ATTN_EXT:
                    {
                        ...
                        // Calculate optimal L2 cache-aware block sizes (matching L2-only logic in ops.cpp)
